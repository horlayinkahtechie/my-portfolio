  ...
  return (
    ...
    >
      ...
      <p className="w-[100%] lg:w-[60%] text-white mt-5 leading-[35px] text-[19px] lg:text-[20px] lg:tracking-tight tracking-wide">
        ...
        industry-standard technologies, ensuring that I stay up to date with the
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 mt-[50px]">
        ...
        <div className="lg:p-[60px] p-[0px] pt-[50px] pl-[0px]">
          ...
          <p className="mt-4 text-white font-bold text-[19px] lg:text-[20px] lg:tracking-tight tracking-wide mb-[30px] leading-[36px]">
            In this course, I learnt everything I need to know about JavaScript,
            from String, Array, Objects, Loops, Conditional Statement and much
            more.
          </p>
          <Link
            className="text-white text-[25px] flex gap-5 font-[Inconsolata]"
        ...
        <div className="lg:p-[60px] p-[0px] pt-[50px] pl-[0px]">
          ...
          <p className="mt-4 text-white font-bold text-[19px] lg:text-[20px] lg:tracking-tight tracking-wide mb-[30px] leading-[36px]">
            ...
            and enhance with AI tools such as Adobe Podcast, Adobe Premier Pro,
            OBS and Shotcut.
          </p>
          <Link
            className="text-white text-[25px] flex gap-5 font-[Inconsolata]"
        ...
        <div className="lg:p-[60px] p-[0px] pt-[50px] pl-[0px]">
          ...
          <p className="mt-4 text-white font-bold text-[19px] lg:text-[20px] lg:tracking-tight tracking-wide mb-[30px] leading-[36px]">
            I was Introduced to the basics of User Experience. How to empathize,
            define and ideate what users need.
          </p>
          <Link
            className="text-white text-[25px] flex gap-5 font-[Inconsolata]"
            href="#"
        ...
        <div className="lg:p-[60px] p-[0px] pt-[50px] pl-[0px]">
          ...
          <p className="mt-4 text-white font-bold text-[19px] lg:text-[20px] lg:tracking-tight tracking-wide mb-[30px] leading-[36px]">
            In this course, I learnt about how to sketch a design on a paper and
            digitally.
          </p>
          <Link
            className="text-white text-[25px] flex gap-5 font-[Inconsolata]"
