  ...
  return (
    <div className="lg:mt-[100px]  mt-[50px] p-[15px] lg:p-0 lg:ml-[150px] lg:mr-[150px]">
      ...
      <p className="w-[100%] lg:w-[70%] text-white mt-5 leading-[35px] text-[19px] lg:text-[20px] lg:tracking-tight tracking-wide">
        ...
        categorized meals and drinks, place orders, and reserve seats through a
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 mt-[100px] text-white">
        <div className="p-6">
          ...
          <p className="text-[20px] leading-8 mb-8">
            I also used a utility-first CSS framework used for styling. Tailwind
            allowed for rapid design and responsiveness, ensuring a consistent
            and modern look across all devices.
          </p>
          <p className="text-[20px] leading-8 mb-8">
            Then I used React Router for navigating between pages such as Home,
            Menu, Reservation, Order Summary, and Admin Dashboard without
            reloading the page (client-side routing). A separate interface built
            with the same React architecture that allows restaurant managers to
            view and manage customer orders, reservations, and menu items.
          </p>

          <p className="text-[20px] leading-8 mb-8">
            Supabase handles the: Data storage (menu items, orders,
            reservations, users), real-time updates (e.g., new orders appearing
            in the admin dashboard), Authentication (used for login/signup), API
            access to interact with the frontend easily.
          </p>
        </div>
        ...
        <div className="p-6">
          ...
          <p className="text-[20px] leading-8 mb-8 font-[200px]">
            ...
            restaurant by offering a seamless digital platform. It enables users
            to easily browse the menu, place orders, and reserve seats from any
            device, enhancing convenience, reducing wait times, and improving
          ...
          <p className="text-[20px] leading-8 mb-8">
            ...
            and intuitive experience for both customers and restaurant managers.
          </p>
        </div>
      </div>
    </div>
