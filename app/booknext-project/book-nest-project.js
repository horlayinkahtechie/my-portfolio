          ...
          <div className="lg:p-6 p-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-1">
                ...
                <p className="text-[20px] leading-8 mb-8">
                  When a user wants to book a room, they fill out a form with
                  their name, email,number of days they want to use, check in
                  and check out dates, and payment methods.The system then
                  calculates the total cost based on the number of nights and
                  the room&apos;s price.
                </p>
              </div>
